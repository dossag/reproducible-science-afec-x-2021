...
In this current exercise, you are asked the following questions:

***Questions:***

1. to construct your first R markdown document that reproduces exactly the formatting of the workshop outline document by replacing Dossa's information by your own (e.g., replace **Dossa** by **your_name**). Make sure you put in italic what should be in italic and in bold what you should be in bold;

2. to include photo:

    2.1 to download the logo of your current institute and add it in your R markdown document as a big size;

    2.2 to repeat the previous question but by this time reducing the size of the photo output;

    2.3. to add a photo of yourself but here add a caption as follows (Figure 3: Photo of "your_name");

3. to include Table:

    3.1. Include by hand a table of at of two column named ("Names", "Sex") and at least 3 rows, fill in rows the names of yourself, your highest degree supervisor or your current boss;

    3.2. to include the same table but by using [RMarkdown table generator](https://www.tablesgenerator.com/markdown_tables);

    3.3. to knitr your document to get a ***html*** document;

4. Save the html output and share with the class.



***Answers***
# **Q1:For the text and formatting**   
...
First make sure you downloaded your institue logo and save in the same directory as your rmarkdown document. Then, include the photo.
...
### **Personal photo**
```{r, echo=FALSE,out.width='20%', fig.align='center', fig.cap='Figure 3: Photo of Dossa', include=TRUE, results="hold"}
knitr::include_graphics('Dossa Photo for website.JPG')
```
