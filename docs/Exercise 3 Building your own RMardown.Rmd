...
In this current exercise, you were asked:
...
2. to download the logo of your current institute and add it in your R markdown document as a big size;

3. to repeat the previous question but by this time reducing the size of the photo output;

4. to add a photo of yourself but here add a caption as follows (Figure 3: Photo of "your_name");

5. to include by hand a table of at of two column named ("Names", "Sex") and at least 3 rows, fill in rows the names of yourself, your highest degree supervisor or your current boss;

6. to include the same table but by using [RMarkdown table generator]();

7. to knitr your document to get a ***html*** document.
